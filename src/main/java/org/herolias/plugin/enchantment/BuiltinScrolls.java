...
public final class BuiltinScrolls {
    ...
    static {
        ...
        reg("Scroll_Durability_I",   "Uncommon", 1, "Enchanting_Armor", "Enchanting_Tools", "Enchanting_Melee", "Enchanting_Ranged");
        reg("Scroll_Durability_II",  "Rare",     2, "Enchanting_Armor", "Enchanting_Tools", "Enchanting_Melee", "Enchanting_Ranged");
        reg("Scroll_Durability_III", "Epic",     3, "Enchanting_Armor", "Enchanting_Tools", "Enchanting_Melee", "Enchanting_Ranged");
        ...
        reg("Scroll_Sturdy_I",    "Legendary", 4, "Enchanting_Armor", "Enchanting_Tools", "Enchanting_Melee", "Enchanting_Ranged");
