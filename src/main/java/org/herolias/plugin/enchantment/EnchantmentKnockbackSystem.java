 ...
 * Uses hybrid approach: enhances existing knockback or creates new horizontal knockback.
 */
public class EnchantmentKnockbackSystem extends DamageEventSystem {
    ...
    public void handle(int index, 
        ...
        TransformComponent attackerTransform = commandBuffer.getComponent(ctx.attackerRef(), TransformComponent.getComponentType());
